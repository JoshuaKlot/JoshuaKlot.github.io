...
<div class="fade-in">
<h2>Projects</h2>
<p>I've also worked on my fair share of non gaming, programming related projects, such as making these websites for other people (and myself), using machine learning to detect faces on a raspberry pi, and making an edge detection GUI. Those projects can also be viewed here.</p> 
</div>
</body>
<style>
  .fade-in {
